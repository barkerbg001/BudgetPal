...
function pickLocalJoke(random: boolean): FinanceJoke {
  const index = random
 ...
 * Falls back to local BudgetPal classics if the upstream API is unavailable.
 */
export async function getFinanceJoke(
